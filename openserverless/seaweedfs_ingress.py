...
def create_s3_ingress_endpoint(data, runtime, apihost, owner=None):
    ...
    if runtime == 'openshift':
        return deploy_seaweedfs_route(apihost,"openserverless","seaweedfs-s3","seaweedfs","9000","/")
    else:
        return deploy_seaweedfs_ingress(apihost,"openserverless","seaweedfs-s3","seaweedfs","9000","/")
...
def create_console_ingress_endpoint(data, runtime, apihost, owner=None):
    ...
    if runtime == 'openshift':           
        return deploy_seaweedfs_route(apihost,"openserverless","seaweedfs-filer","seaweedfs","9090","/")
    else:
        return deploy_seaweedfs_ingress(apihost,"openserverless","seaweedfs-filer","seaweedfs","9090","/")
