...
import openserverless.enterprise_util as cfg_util
import openserverless.enterprise_util as cfg_util
...
def create(owner=None):
    ...
    cfg.put("openserverless.kafka.url",get_kafka_connect_data())    
    logging.info(f"kafka connection string is {cfg.get('openserverless.kafka.url')}")    
