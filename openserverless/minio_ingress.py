...
def deploy_minio_upload_route(apihost,namespace, type):
    ...
    upload.with_service_name("openserverless-minio")
...
def create_api_uploader_endpoint(runtime, apihost, owner=None):
    ...
    if runtime == 'openshift':           
        return deploy_minio_upload_route(apihost,"openserverless","minio-upload")
    else:
        return deploy_minio_upload_ingress(apihost,"openserverless","minio-upload")
...
def create_s3_ingress_endpoint(data, runtime, apihost, owner=None):
    ...
    """
    if runtime == 'openshift':
        return deploy_minio_route(apihost,"openserverless","minio-s3","openserverless-minio","9000","/")
    else:
        return deploy_minio_ingress(apihost,"openserverless","minio-s3","openserverless-minio","9000","/")
...
def create_console_ingress_endpoint(data, runtime, apihost, owner=None):
    ...
    if runtime == 'openshift':           
        return deploy_minio_route(apihost,"openserverless","minio-console","openserverless-minio","9090","/")
    else:
        return deploy_minio_ingress(apihost,"openserverless","minio-console","openserverless-minio","9090","/")
