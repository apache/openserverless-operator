...
import openserverless.openwhisk_standalone as standalone
import openserverless.openwhisk_enterprise as enterprise
import openserverless.kube as kube
from openserverless.util import nuv_retry
...
def create(owner=None):
    ...
    logging.info("*** creating openwhisk in enterprise mode")
    return enterprise.create(owner)        
