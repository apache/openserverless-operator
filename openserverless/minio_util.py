...
class MinioClient:
    ...
    def __init__(self):
        self.minio_api_host   = cfg.get("minio.host", "MINIO_API_HOST", "openserverless-minio")
        ...
        # automatically adds the local alias to mc configuration to operate on openserverless main MINIO server
