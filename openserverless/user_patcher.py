...
#
import logging, time
import openserverless.kopf_util as kopf_util
...
def patch(ucfg: UserConfig, user_metadata: UserMetadata, diff, status, owner=None, name=None):
    """
    Implements the patching logic of the openserverless operator to handle chanages on the openserverless wsku 
    resources.
    """
    logging.info(status)
